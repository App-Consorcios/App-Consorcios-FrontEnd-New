...
export class VerUnidadComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.forma.contains['ubicacion'].controls['codigo'].setValue(this.unidadesFuncionales[this.pagActual].ubicacion)
    this.forma.contains['ubicacion'].controls['descrp'].setValue(this.unidadesFuncionales[this.pagActual].descripcion)
